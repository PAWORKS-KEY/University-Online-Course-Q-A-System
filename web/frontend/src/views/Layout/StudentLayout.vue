<template>
    <el-container class="student-layout">
        <el-aside width="200px" class="sidebar">
            <div class="logo">
                <el-text tag="b" style="color: white;">学生学习中心</el-text>
            </div>
            ...
            >
                ...
                <el-menu-item index="/student/resources/upload">
                    <span>学习资料上传</span>
                </el-menu-item>

                <el-menu-item index="/student/qa/ask">
                    <span>我要提问</span>
                </el-menu-item>

                <el-menu-item index="/student/qa/answered-reminders">
                    <span>已回答提醒</span>
                </el-menu-item>

                <el-menu-item index="/student/qa/search">
                    <span>全站问答搜索</span>
                </el-menu-item>
